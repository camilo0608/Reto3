...
import application.service.ServiciosReservaciones;
...
/**
*ControladorReservaciones
*Esta Clase implementa los metodos para la clase Reservaciones
...
/**
*Definicion del metodo GET para el id de Reservaciones 
*Contiene el codigo del metodo GET para consultar la informacion
*almacenada en el id de una determinada reservacion 
*
*/
    @GetMapping("/{id}")
...
/**
*Definicion del metodo POST para la tabla Reservaciones
*Contiene el codigo del metodo POST para guardar nueva informacion
*en un id especifico de una reservacion
*
*/
    @PostMapping("/save")
    ...
    /**
*Definicion del metodo PUT para la tabla Reservaciones
...
*/
    ...
    /**
*Definicion del metodo DELETE para la tabla Reservaciones
